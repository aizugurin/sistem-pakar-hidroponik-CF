...
<div class="container">
	<div class="card shadow p-5 mb-5">
        ...
        <div class="card-body">
            <a href="penyakit-simpan.php" class="btn btn-primary"><span class="fa fa-plus"></span>&nbsp; Tambah Data</a>
            <br>
            <br>
                ...
                <table class="table table-bordered">
                    ...
                    while ($a=mysqli_fetch_array($penyakit)) {?>
                        <tr>
                            ...
                            <td class="text-justify"><?= $a['solusi'] ?></td>
                            
                            <td class="text-center">
                                <a href="penyakit-ubah.php?id_penyakit=<?= $a['id_penyakit'] ?>" class="btn btn-secondary"><span class="fa fa-pen"></span></a>
                                <a href="penyakit.php?id_penyakit=<?= $a['id_penyakit'] ?>&aksi=hapus" class="btn btn-danger"><span class="fa fa-trash"></span></a>
                            </td>
                        </tr>
                        <?php } ?>
                </table>
