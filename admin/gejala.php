...
<div class="container">
	<div class="card shadow p-5 mb-5">
        ...
        <div class="card-body">
            <a href="gejala-simpan.php" class="btn btn-primary"><span class="fa fa-plus"></span>&nbsp; Tambah Data</a>
            <br>
            <br>
                    ...
                    while ($a=mysqli_fetch_array($gejala)) {?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="gejala-ubah.php?id_gejala=<?= $a['id_gejala'] ?>" class="btn btn-secondary"><span class="fa fa-pen"></span></a>
                                <a href="gejala.php?id_gejala=<?= $a['id_gejala'] ?>&aksi=hapus" class="btn btn-danger"><span class="fa fa-trash"></span></a>
                            </td>
                        </tr>
                        <?php } ?>
                </table>
